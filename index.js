  ...
  const config = {
    ...
    inbounds: [
      ...
      { 
        ...
        protocol: "vless", 
        settings: { clients: [{ id: UUID, level: 0 }], decryption: "none" }, 
        streamSettings: { network: "xhttp", security: "none", xhttpSettings: { mode: "stream-one", path: "/vless-xhttp" } }, 
        sniffing: { enabled: true, destOverride: ["http", "tls", "quic"], metadataOnly: false } 
      }
    ],
...
vless://${UUID}@${CFIP}:${CFPORT}?encryption=none&security=tls&sni=${argoDomain}&fp=firefox&type=xhttp&host=${argoDomain}&path=%2Fvless-xhttp&mode=stream-one#${nodeName}-xhttp
      `.trim();
